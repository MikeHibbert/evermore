...
afterAll(() => {
 ...
 describe("Filesystem Ops", () => {
    describe("Should list files and all folder recursively", () => {
    ...
    describe("Path Info Objects should match eachother", () => {
    ...
    describe("Should be able to generate CRC from large file", async  () => {
