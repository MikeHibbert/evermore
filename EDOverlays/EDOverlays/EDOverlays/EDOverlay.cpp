// CEDOverlay.cpp : Implementation of CCEDOverlay

#include "pch.h"
#include "EDOverlay.h"

#include "EDOverlayFactory.h"
...
CEDOverlay::CEDOverlay(int state): 
    _referenceCount(1), 
    _state(state)
{
}

CEDOverlay::~CEDOverlay(void)
{
}


IFACEMETHODIMP_(ULONG) CEDOverlay::AddRef()
{
    return InterlockedIncrement(&_referenceCount);
}

IFACEMETHODIMP CEDOverlay::QueryInterface(REFIID riid, void** ppv)
{
    HRESULT hr = S_OK;
...
IFACEMETHODIMP_(ULONG) CEDOverlay::Release()
{
...
IFACEMETHODIMP CEDOverlay::GetPriority(int* pPriority)
{
...
IFACEMETHODIMP CEDOverlay::IsMemberOf(PCWSTR pwszPath, DWORD dwAttrib)
{
...
IFACEMETHODIMP CEDOverlay::GetOverlayInfo(PWSTR pwszIconFile, int cchMax, int* pIndex, DWORD* pdwFlags)
{
    *pIndex = 0;
